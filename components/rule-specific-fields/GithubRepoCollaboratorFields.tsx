...
export function GithubRepoCollaboratorFields({ value, onChange }: RuleSpecificFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">Become a GitHub Repository Collaborator</h3>
