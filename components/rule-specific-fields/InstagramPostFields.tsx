...
export function InstagramPostFields({ value, onChange }: RuleSpecificFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">Post on Instagram</h3>
      <p className="text-sm text-gray-600">
        Reward users for posting on Instagram with specific text.
      </p>
