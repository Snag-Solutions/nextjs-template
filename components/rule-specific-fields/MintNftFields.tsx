...
/**
 * Specific fields for "Mint an NFT" (MintOn) rule type.
 */
export function MintNftFields({ value, onChange }: RuleSpecificFieldProps) {
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">Mint an NFT</h3>
      <p className="text-sm text-gray-600">
        Reward users for minting a specific NFT from the collection.
      </p>
