...
export function DiscordMemberFields({ value, onChange }: RuleSpecificFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">Get Discord Role</h3>
      ...
      <div className="flex flex-col gap-2">
        <span className="text-sm font-medium">Role ID(s)</span>
        <p className="text-xs text-gray-500">
          Go to Server Settings → Roles, then right-click the role and select Copy ID. Users will be rewarded if they have any of the roles below.
        </p>
        {roles.map((role, i) => (
