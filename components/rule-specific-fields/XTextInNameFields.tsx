...
export function XTextInNameFields({ value, onChange }: RuleSpecificFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">Add Text to X Username</h3>
      <p className="text-sm text-gray-600">
        Reward users for adding specific text to their X username.
      </p>
      <label className="flex flex-col gap-1">
        <span className="text-sm font-medium">Text to check in X Name *</span>
        <input
          type="text"
          ...
          placeholder="Text to check in Twitter Name"
