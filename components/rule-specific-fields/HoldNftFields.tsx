...
/**
 * Specific fields for "Hold an NFT" (TokenHold) rule type.
 */
export function HoldNftFields({ value, onChange }: RuleSpecificFieldProps) {
  return (
    <div className="flex flex-col gap-4">
      <h3 className="text-lg font-semibold">Hold an NFT</h3>
      <p className="text-sm text-gray-600">
        Reward users for holding a specific NFT from the collection.
      </p>
